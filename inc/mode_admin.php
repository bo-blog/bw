...
if ($canonical->currentArgs['mainAction']=='center')
{
	if ($canonical->currentArgs['subAction']=='store')
	{
		...
		$acceptedKeys=array ('siteName', 'siteURL', 'authorName', 'authorIntro', 'siteKey', 'siteTheme', 'siteLang', 'perPage', 'linkPrefixIndex', 'linkPrefixCategory', 'linkPrefixArticle', 'social-sina-weibo', 'social-weixin', 'social-douban', 'social-instagram', 'social-renren', 'social-linkedin', 'externalLinks');
