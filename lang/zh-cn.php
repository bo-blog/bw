...
$conf['l'] = array(
	...
	'page:SinglePage' => '单页',
	'page:Search' => '搜索',
	'page:pageSelector' => '所有分页',
	'page:EnterToSearch' => '按下回车键搜索',
	...
	'admin:item:EmbededSearch' => '站内搜索选用搜索引擎',
	'admin:item:MailStatus' => '自动发送邮件通知',
	'admin:item:MailAddr' => '发信邮箱',
	'admin:item:MailServer' => '发信邮箱SMTP地址',
	'admin:item:MailPort' => '发信邮箱SMTP端口',
	'admin:item:MailPassword' => '发信邮箱密码',
	...
	'admin:opt:NewComments' => '有新评论时',
	'admin:opt:ChangedPsw' => '修改密码后',
	'admin:opt:LoginFailure' => '尝试登陆失败时',
	...
	'admin:msg:Disqus' => '【Disqus】是一项由 <a href="https://disqus.com" target="_blank">disqus.com</a> 提供的社会化评论服务。',
	...
	'admin:msg:InvalidArticleID' => '文章ID包含特殊字符。只能使用英文字母、横杠和下划线。',
	'admin:msg:InvalidCateName' => '分类ID包含特殊字符。只能使用英文字母、横杠和下划线。',
	'admin:msg:MailAddrSMTP' => '提供支持SMTP发信的邮箱地址并输入以下所有信息。',
	'admin:msg:MailInfoRequired' => '测试失败：发信邮箱及其SMTP地址、端口和密码、收件邮箱均必填，且格式要正确。',
	'admin:msg:SendFailed' => '测试失败：请检查所填信息是否正确。',
	'admin:msg:TestPassed' => '测试邮件已发送。请前往收件箱检查是否收到。',
	'admin:msg:AddedCommentTo' => '评论了',
	'admin:msg:RiskNotify' => '登陆尝试风险提示',
	'admin:msg:SomeoneFailed' => '在 %s 有人（IP: %s ）尝试登陆但失败了。请注意保护密码。',
	'admin:msg:AutoNoReply' => '这是一个自动发送的邮件通知，请勿直接回复。',
